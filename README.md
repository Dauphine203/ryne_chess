...
```bash
git clone https://github.com/JohnDoe/ryne_chess.git
cd ryne_chess
git remote add upstream https://github.com/Dauphine203/ryne_chess.git
```
...
First, be sure you master is up to date; on your remote fork on github (here `JohnDoe/ryne_chess`)
you should see `This branch is even with Dauphine203/ryne_chess`. If not, you need to update:
